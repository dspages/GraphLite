...
class SessionForm extends React.Component {
  ...
  oprWarn(){
    if(window.opr){
      //If user is using Opera web browser
      return (<div className="browser-compat">
        This site looks best with  <a href="https://www.google.com/chrome/browser/desktop/index.html">
    ...
    return (
      <div className="form-container">
        <nav className="greeting-box">
          ...
          <h2>Log in to GraphLite - a free data visualization app</h2>
          <div className="header-button-box">
            <button onClick={this.pushButton.bind(this)} className="auth-item">Go To Sign Up</button>
        ...
        <form className="form-style-7">
          ...
          <li>
              <input onClick={this.submitForm.bind(this)} type="submit" value="Sign In" />
          </li>
          </ul>
         </form>
